...
To create the library, I used this documentation [PDF](https://www.researchgate.net/publication/318925679_Leveraging_the_SRTP_protocol_for_over-the-network_memory_acquisition_of_a_GE_Fanuc_Series_90-30) that explains the basic structure of the data to be passed for establishing the connection and for data exchange.
